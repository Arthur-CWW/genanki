...
class TestWithCollection:
    ...
    def test_media_files_absolute_paths(self):
        ...
        package = genanki.Package(
            deck, media_files=[present_mp3_path, present_jpg_path]
        )
        self.import_package(package)
    ...
    def test_notes_with_due1(self):
        ...
        deck.add_note(
            genanki.Note(TEST_MODEL, ["Capital of Washington", "Olympia"], due=1)
        )
    ...
    def test_notes_with_due2(self):
        ...
        deck.add_note(
            genanki.Note(TEST_MODEL, ["Capital of Washington", "Olympia"], due=2)
        )
